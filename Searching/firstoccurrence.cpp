...
// int IndexfirstOcurrence(int arr[],int low,int high,int x)
//  {
//     // int low=0, high=n-1;
//     // int mid=(low+high)/2;
// //      while(low<=high)
...
// if(arr[mid]>x){
//     return IndexfirstOcurrence(arr,low,mid-1,x);
// }
// else if(arr[mid] < x){
//     return IndexfirstOcurrence(arr,mid+1,high,x);
// }
// else
// 	{
...
// int main()
// {
//     int arr[]={10, 10, 10, 10, 10, 20, 20};
//     int n=7;
//      cout<<IndexfirstOcurrence(arr,0,n-1,10);
//     return 0;
// }
